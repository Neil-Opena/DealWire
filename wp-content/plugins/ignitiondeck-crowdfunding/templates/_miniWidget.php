a<div class="ignitiondeck id-widget id-mini <?php echo (($mini_deck->successful) ? 'success' : ''); ?> <?php echo $mini_deck->post_id; ?>" data-projectid="<?php echo (isset($project_id)? $project_id : ''); ?>">
	<div class="id-product-infobox">
		<div class="product-wrapper">
			...
			<div class="pledge">
				<?php $mini_image = ID_Project::get_project_thumbnail($mini_deck->post_id, 'medium'); ?>
