...
function fivehundred_credits_option() {
	if (function_exists('is_id_pro') && is_id_pro()) {
		$disable = get_theme_mod('fivehundred_disable_credits', 0);
		if (isset($_POST['submit-theme-settings'])) {
			$disable = isset($_POST['fivehundred_disable_credits']) ? absint($_POST['fivehundred_disable_credits']) : 0;
			set_theme_mod('fivehundred_disable_credits', $disable);
			do_action('fivehundred_disable_credits_set', $disable);
		}
		$content = '<tr class="fivehundred_credits_option">';
		$content .= '<td>';
		$content .= '<p>';
		$content .= '<input type="checkbox" id="fivehundred_disable_credits" name="fivehundred_disable_credits" value="1" '.($disable ? 'checked="checked"' : '').'/>';
...
function fivehundred_scripts() {
	...
	wp_register_script('fivehundred-js', get_template_directory_uri().'/js/fivehundred.js');
...
function fivehundred_admin_scripts() {
	global $pagenow;
	wp_register_script('fivehundred-admin-js', get_template_directory_uri().'/js/fivehundred-admin.js');
	wp_register_style('fivehundred-admin', get_template_directory_uri().'/style-admin.css');
	...
	wp_register_style('fh-style', get_template_directory_uri().'/admin-style.css');
