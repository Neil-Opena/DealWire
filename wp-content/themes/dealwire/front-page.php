	...
	<div id="container">
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<h2 class="entry-title"><?php echo apply_filters('featured_projects_title', __('Featured Projects', 'fivehundred')); ?></h2>
				...
				<div  id="home-sharing">
				<ul>
					<?php echo (!empty($via) ? '<li class="twitter-btn"><a href="http://twitter.com/'.$via.'" target="_blank" ><span>'.__('Follow', 'fivehundred').'</span></a></li>' : ''); ?>
					<?php echo (!empty($fbname)  ? '<li class="facebook-btn"><a href="http://www.facebook.com/'.$fbname.'" target="_blank"><span>'.__('Like', 'fivehundred').'</span></a></li>' : ''); ?>
					<?php echo (!empty($gname) ? '<li class="gplus-btn"><a href="https://plus.google.com/'.$gname.'" target="_blank"><span>'.__('+1', 'fivehundred').'</span></a></li>' : ''); ?>
					<?php echo (!empty($liname) ? '<li class="linkedin-btn"><a href="'.$liname.'" target="_blank"><span>'.__('Connect', 'fivehundred').'</span></a></li>' : ''); ?>
