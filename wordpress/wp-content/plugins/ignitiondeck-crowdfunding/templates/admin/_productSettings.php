						...
						<div>
							<form name="formdefaultsettings" id="formdefaultsettings" action="" method="post">
								<table>
									<?php if ($platform == 'legacy') { ?>
									<tr>
										<td><strong><?php _e('Currency Code', 'ignitiondeck'); ?></strong></td>
									...
									<tr>
										<td><strong><?php _e('Field Name', 'ignitiondeck'); ?></strong></td>
										<td><strong><?php _e('Enabled', 'ignitiondeck'); ?></strong></td>
										<td><strong><?php _e('Mandatory', 'ignitiondeck'); ?></strong></td>
									</tr>
									<tr>
										<td><?php _e('First Name', 'ignitiondeck'); ?></td>
									...
									<tr>
										<td><?php _e('Email', 'ignitiondeck'); ?></td>
									...
									<tr>
										<td><strong><?php echo _e('Default Thank You Page', 'ignitiondeck'); ?></strong></td>
									</tr>
									<tr>
										<td>
											<select name="ign_option_ty_url" id="select_ty_pageurls" onchange=storetyurladdress();>
												<option value="page_or_post" <?php echo (!empty($ty_default['option']) && $ty_default['option'] == 'page_or_post' ? 'selected="selected"' : ''); ?>><?php echo _e('Page or Post', 'ignitiondeck'); ?></option>
												<option value="external_url" <?php echo (!empty($ty_default['option']) && $ty_default['option'] == 'external_url' ? 'selected="selected"' : ''); ?>><?php echo _e('External URL', 'ignitiondeck'); ?></option>
											</select>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td>
								            ...
								            <select name="ign_ty_post_name" id="">
								            	<option value="0"><?php echo _e('Select', 'ignitiondeck'); ?></option>
												<?php if ($list->have_posts()) {
													while ($list->have_posts()) {
														$list->the_post();
														$post_id = get_the_ID();
