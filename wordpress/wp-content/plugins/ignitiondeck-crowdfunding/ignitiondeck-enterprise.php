...
function id_submissionForm($post_id = null) {
	...
	$vars = array(
		...
		'project_end_type' => 'open', // default to open #devnote make this an option
		'project_start' => date('m/d/Y'), // default to today
		'project_end' => date('m/d/Y', strtotime('+30 days')), // default to 30 days #devnote make an option
	);
