...
= How to use the link and link label? =
You can set a link (URL) to a post, page or website while adding an event or a widget.

And you can label this link. Default label for event is "More info" and default label for widget is "All events".

This will be displayed in frontend, in event list and single event or in widget.
